        ...
        <div style=" padding: 5%; padding-top : 9%; padding-bottom : 0%; min-height:75dvh;">
            ...
            <form method="GET" action="formLayan.php">
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <button type="submit" name="layanan" value="Vaksin Rubella" 
                    class="relative w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style = "height: 250px">
                        <img class="absolute inset-0 bg-cover w-full h-full rounded-lg opacity-30 blur-sm hover:blur-none"
                            src="../assets/image/rubella.jpg"
                            alt="Gambar Rubella">
                        <div class="relative">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Vaksin Rubella</h5>
                            <p class="mb-3 font-normal text-gray- font-semibold">Vaksin .... adalah vaksin yang sedang dikembangkan untuk mengatasi masalah stunting atau kerdil pada anak-anak. Stunting disebabkan oleh kekurangan gizi kronis sehingga anak tidak tumbuh secara optimal.</p>
                        </div>
                    </button>
                    ...
                    <button type="submit" name="layanan" value="Vaksin Hepatitis A dan B" 
                    class="relative w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style = "height: 250px">
                        <img class="absolute inset-0 bg-cover w-full h-full rounded-lg opacity-30 blur-sm hover:blur-none"
                            src="../assets/image/hepatitis.png"
                            alt="Gambar Hepatitis A dan B">
                        <div class="relative">
                            <h5 class="mb-2 text-2xl font-bold text-white tracking-tight text-gray-900 dark:text-white">Vaksin SputnikV</h5>
                            <p class="mb-3 font-normal text-white font-semibold">SputnikV adalah vaksin COVID-19 yang dikembangkan oleh Pusat Riset Epidemiologi dan Mikrobiologi Gamaleya di Rusia. Vaksin ini menggunakan teknologi vektor virus yang sama dengan vaksin AstraZeneca.</p>
                        </div>
