        ...
        <div class="bg-gray-100">
            <div style=" padding: 5%; padding-top : 9%; padding-bottom : 0%; min-height:75dvh;">
                ...
                <div class="border-2 border-gray-800 py-8 mx-auto" style="width:50%; margin-bottom : 8%;">
                    <form class="max-w-md mx-auto close" method="POST" action = "../assets/mySql/insert.php">
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    closeButton.addEventListener("submit", function(event) {
                        ...
                        Swal.fire({
                            ...
                            icon: "success",
                            confirmButtonText: "Ke Nganu Insert"
                        }).then((result) => {
                            if (result.isConfirmed) {
                                closeButton.submit();
                                // window.location.href = "../assets/mySql/insert.php";
