...
<body>
    ...
    <div class="bg-gray-100">
        <div style=" padding: 5%; padding-top : 9%; padding-bottom : 0%; min-height:75dvh;">
            <p class="text-center text-4xl font-bold text-gray-600 mb-10"> Edit Form <?= $data['selectedLayanan'] ?></p>
            ...
            <div class="border-2 border-gray-800 py-8 mx-auto" style="width:50%; margin-bottom : 8%;">
                <form class="max-w-md mx-auto" method="POST" action="../assets/mySql/proses.php" id="editForm">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="first_name" id="first_name"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " value="<?= $data['namaP']; ?>" required />
                            <!-- ah freaky first name -->
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Vaksin: </label>
                        <select id="countries"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="selectedLayanan">
                            ...
                            <option value="Vaksin Stunting">Vaksin Stunting</option>
                            <option value="Vaksin BioNTech">Vaksin BioNTech</option>
                            <option value="Vaksin Sinopharm">Vaksin Sinopharm</option>
                            <option value="Vaksin Janssen">Vaksin Janssen</option>
                            <option value="Vaksin SputnikV">Vaksin SputnikV</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 flex justify-center items-center">
                        <button type="submit" name="submitEdit" value="submitEdit"
                            ...
                            <svg class="w-6 h-6 inline-block mr-2 text-whitetext-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
