                    ...
                    <form class="max-w-md mx-auto close" method="POST" action = "../assets/mySql/proses.php">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <!-- $selectedLayanan -->
                                <input type="hidden" name="selectedLayanan" value="<?=$data['selectedLayanan']?>">
                        ...
                        <div class="grid grid-cols-2 gap-6 flex justify-center items-center">
                            <button type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 mx-auto focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-32 px-2 py-2 flex items-center justify-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name ="submitEdit">
